data = load('ex1data3.txt') % Load the dataset
...
iterations = 150000 % number of iterations
...
population = input("Enter the ID to predict Heart Rate: ") % Taking input to predict population
predicted_profit = [1, population]*theta
[1,population]